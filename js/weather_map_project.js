...
let append = (data) => {
    ...
    for  (let i = 0; i < data.length; i += 8){
        ...
        html += `
            <div class="card border-light card background-color: white" style="width: 20%>
               <h6 class="card-header text-center text-dark opacity-75 " style="font-size: small">${dt_txt.substring(5,7)}.${dt_txt.substring(8,10)}.${dt_txt.substring(0,4)}
               </h6>
